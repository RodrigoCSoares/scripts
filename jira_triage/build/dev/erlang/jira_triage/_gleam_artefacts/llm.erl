...
call_ollama(Prompt) ->
    ...
    Req = begin
        ...
        _pipe@4 = gleam@http@request:set_port(_pipe@3, 11434),
        _pipe@5 = gleam@http@request:set_path(_pipe@4, <<"/api/generate"/utf8>>),
        ...
        {ok, Resp} ->
            case erlang:element(2, Resp) of
                200 ->
                    ...
                    _pipe@7 = gleam@json:parse(erlang:element(4, Resp), Decoder),
