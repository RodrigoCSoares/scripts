...
-define(FILEPATH, "src/shellout.gleam").
-export([display/1, color/1, background/1, style/3, arguments/0, command/4, exit/1, which/1]).
            ...
            <<"background"/utf8>> ->
                ...
                gleam@dict:map_values(
                    ...
                    fun(_, Code) ->
                        ...
                        Code@4 = case gleam_stdlib:parse_int(Code@2) of
                            {ok, Code@3} -> Code@3;
                            _assert_fail@1 ->
                                erlang:error(#{gleam_error => let_assert,
                                            message => <<"Pattern match failed, no pattern matched the value."/utf8>>,
                        ...
                        [erlang:integer_to_binary(Code@4 + 10)]
                    end
                );
                    ...
                    {ok, Int} ->
                        ...
                        case Rgb_counter < 3 of
                            true when Rgb_counter > 0 ->
                                {Values@1, Styles@1} = case erlang:element(
                                    2,
                                    Acc@1
                                ) of
                                    [{rgb, Values} | Styles] -> {Values, Styles};
                                    _assert_fail@2 ->
                                        erlang:error(
